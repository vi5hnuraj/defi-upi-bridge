    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Seamlessly bridge the gap between traditional banking and DeFi. Link your UPI ID, connect your Metamask wallet, and experience the speed of sending fiat payments that arrive directly as crypto.
        </p>
      </div>
